...
### 📁 Financial Data Analysis *(en desarrollo)*
Análisis cuantitativo del mercado bursátil mediante Python, cálculo de métricas financieras (ROI, volatilidad, Sharpe Ratio) y visualizaciones interactivas.  
*Tecnologías:* Python · Pandas · yfinance · Plotly

### 📁 Finance Dashboard *(en desarrollo)*
Dashboard interactivo de KPIs financieros para el seguimiento del rendimiento empresarial.  
